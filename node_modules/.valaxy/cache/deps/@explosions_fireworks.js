...
// node_modules/.pnpm/@explosions+fireworks@0.1.0/node_modules/@explosions/fireworks/dist/index.mjs
...
function createFireworks(config) {
  ...
  function setParticleDirection(p) {
    const angle = anime_es_default.random(0, 360) * Math.PI / 180;
    const value = anime_es_default.random(
      diffuseRadius.min,
      diffuseRadius.max
    );
    const radius = [-1, 1][anime_es_default.random(0, 1)] * value;
    return {
  ...
  function createParticle(x, y) {
    const tinyColor = new TinyColor(colors[anime_es_default.random(0, colors.length - 1)]);
    tinyColor.setAlpha(anime_es_default.random(0.2, 0.8));
    const p = {
      x,
      y,
      color: tinyColor.toRgbString(),
      radius: anime_es_default.random(circleRadius.min, circleRadius.max),
  ...
  function animateParticles(pos) {
    ...
    anime_es_default.timeline().add({
      ...
      radius: 0.1,
      duration: anime_es_default.random(
        animeDuration.min,
        animeDuration.max
      ),
      easing: "easeOutExpo",
      ...
      {
        targets: circle,
        radius: anime_es_default.random(orbitRadius.min, orbitRadius.max),
        lineWidth: 0,
        alpha: {
          value: 0,
          easing: "linear",
          duration: anime_es_default.random(600, 800)
        },
        duration: anime_es_default.random(1200, 1800),
        easing: "easeOutExpo",
        update: renderParticle
      },
      0
...
//# sourceMappingURL=@explosions_fireworks.js.map
